...
class _Listtile_widetState extends State<Listtile_widet> {
  ...
  Widget build(BuildContext context) {
    ...
    return  InkWell(
            ...
            child: ListTile(
              title: Text(widget.nameOfFood,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              leading: buildChckbox(),
              trailing: Text(widget.price,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),
          );
  }
}
